...
export async function createLead(formData: FormData) {
    ...
    const leadData = {
        ...
        desired_completion_year: formData.get('desired_completion_year') ? parseInt(formData.get('desired_completion_year') as string) : null,
        desired_completion_half: formData.get('desired_completion_half') as string,
