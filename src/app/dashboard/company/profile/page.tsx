        ...
        <div className="pt-24 pb-20 min-h-screen bg-background px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-8">
                    <div className="p-8 md:p-12 bg-white/2 border border-white/10 rounded-[40px]">
                        <div className="flex justify-between items-start mb-10">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-white uppercase tracking-tight">업체 정보 관리</h1>
                                    <p className="text-white/20 text-xs mt-1">상세한 정보 입력은 파트너십 신뢰도를 높여줍니다.</p>
                                </div>
                            </div>
                        ...
                        {isPending && (
                            <div className="mb-10 p-6 bg-orange-500/10 border border-orange-500/20 rounded-[32px] flex items-start gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
                                <Hourglass className="text-orange-400 shrink-0 animate-spin-slow" />
                                <div>
                                    <p className="text-sm font-bold text-white">운영자 승인 대기 중</p>
                                    <p className="text-xs text-white/40 mt-1 leading-relaxed">새로 입력하신 전문 정보를 운영자가 검토 중입니다. 승인 전까지는 추가 수정이 제한됩니다.</p>
                                </div>
                            </div>
                        )}

                        <ProfileForm
                            initialData={company || { company_name: '', business_number: '' }}
                            isPending={isPending}
                        />
                    </div>
